    ...
    <b-row class="mb-5 adanos-input-box">
        <b-col>
            <b-form @submit="onSubmit">
                ...
                <EventCard class="mb-3" title="事件示例" :fold="true" v-if="eventSample !== null" :event="eventSample" :event_index="0" :onlyShow="true"></EventCard>
            </b-form>
        </b-col>
    </b-row>
</template>
...
import {hintHandler} from '@/plugins/editor-helper';
...
export default {
    ...
    methods: {
        onSubmit() {
            ...
            try {
                let data = {expression: this.expression, event_id: this.event_id, event_sample: JSON.parse(this.eventSampleText)};
        ...
        reload() {
            if (this.$route.query.event_id !== undefined) {
                ...
                this.eventSample = {
                    ...
                    "type": "plain",
                    "status": "canceled",
                    "created_at": "2020-10-21T16:20:32.351Z"
                };
                this.eventSampleText = JSON.stringify(this.eventSample, null, "\t");
            }
        }
